    ...
    <div class="col-xl-4 col-lg-5">
        ...
        <div class="box bg-info bg-deathstar-dark">
            <div class="box-body box-profile">
                ...
                <h2 class="profile-username text-center mb-0">{{ $user->first_name }}
                    {{ $user->last_name }}</h2>
                        ...
                        <div class="media-list media-list-hover w-p100 mt-0">
                            <h5 class="media media-single py-10 px-0 w-p100 justify-content-between">
                                ...
                                <p class="text-right pull-right">
                                    {{ count(App\Demande::where([['affecter',$user->id], ['etat' , 5]])->get()) }}
                                </p>
                            </h5>
                            <h5 class="media media-single py-10 px-0 w-p100 justify-content-between">
                                <p>
                                ...
                                <p class="text-right pull-right">
                                    {{ count(App\Demande::where([['affecter',$user->id], ['etat' , 1]])->get()) }}
                                </p>
                            </h5>
                            <h5 class="media media-single py-10 px-0 w-p100 justify-content-between">
                                <p>
                                ...
                                <p class="text-right pull-right">
                                    {{ count(App\Demande::where([['affecter',$user->id], ['etat' , 2]])->get()) }}
                                </p>
                            </h5>
                            <h5 class="media media-single py-10 px-0 w-p100 justify-content-between">
                                <p>
                                ...
                                <p class="text-right pull-right">
                                    {{ count(App\Demande::where([['affecter',$user->id], ['etat' , 3]])->get()) }}
                                </p>
                            </h5>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="first_name" type="text"
                                        ...
                                        value="{{ !is_null(old('first_name')) ? old('first_name') : $user->first_name  }}">
                                    @error('first_name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="last_name" type="text"
                                        ...
                                        value='{{ !is_null(old('last_name')) ? old('last_name') : $user->last_name }}'>
                                    @error('last_name')
                                    <div class="alert alert-danger my-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="email" name="email"
                                        ...
                                        value="{{ !is_null(old('email')) ? old('email') : $user->email }}">
                                    @error('email')
                                    <div class="alert alert-danger my-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="tel" name="phone" placeholder=""
                                        value="{{ !is_null(old('phone')) ? old('phone') : '' }}">
                                    @error('phone')
                                    <div class="alert alert-danger my-1">{{ $message }}</div>
                                    @enderror
                                </div>
